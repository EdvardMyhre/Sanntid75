...
const (
	...
	ID_MODULE_ASSIGNED_TASKS_MANAGER = 192		//110 xxxxx
...
const (
		...
		MESSAGE_TYPE_REQUEST_WEIGHT = (ID_MODULE_ASSIGNED_TASKS_MANAGER | 24)		//xxx 11000
		MESSAGE_TYPE_DISTRIBUTE_ORDER = (ID_MODULE_ASSIGNED_TASKS_MANAGER | 20)		//xxx 10100
		...
		MESSAGE_TYPE_REQUEST_BACKUP = (ID_MODULE_TASK_MANAGER | 20)
